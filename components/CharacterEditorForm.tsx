      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-[#150C1F] border border-[rgba(245,240,250,0.14)] p-6 rounded space-y-4">
            <div>
              <label className="block text-xs font-semibold text-[#9C8FAE] uppercase tracking-wider mb-1.5">Character Name</label>
              <input
                type="text"
                required
          ...
          <div className="bg-[#150C1F] border border-[rgba(245,240,250,0.14)] p-6 rounded space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold text-[#9C8FAE] mb-1">Role / Function</label>
                <input
                  type="text"
                  required
                  ...
                  className="block w-full px-3.5 py-2 bg-[#0B0710] border border-[rgba(245,240,250,0.14)] rounded text-white focus:outline-none focus:ring-1 focus:ring-[#00E5FF] transition text-xs"
                />
              </div>

              <div>
                <label className="block text-xs font-semibold text-[#9C8FAE] mb-1">Affiliation / Organization</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-semibold text-[#9C8FAE] mb-1">Voice Actor / Model</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-xs font-semibold text-[#9C8FAE] mb-1">First Appearance</label>
                <input
                  type="text"
          ...
          <div className="bg-[#150C1F] border border-[rgba(245,240,250,0.14)] p-6 rounded space-y-4">
            ...
            {featuredImage ? (
              <div className="space-y-3">
                ...
                <p className="text-[10px] text-[#9C8FAE]/45 truncate bg-[#0B0710] p-1.5 rounded border border-[rgba(245,240,250,0.08)] font-mono text-center">
                  {featuredImage}
                </p>
              </div>
            ) : (
              <button
                ...
                className="w-full aspect-square border border-dashed border-[rgba(245,240,250,0.14)] rounded flex flex-col items-center justify-center text-[#9C8FAE]/50 hover:border-[#9C8FAE]/20 hover:text-white transition group bg-[#0B0710]/40"
              >
                <Users size={28} className="mb-2 text-[#9C8FAE]/30 group-hover:text-[#FF2E88] transition" />
