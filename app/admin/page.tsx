    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
              ...
              >
                <div className="flex space-x-3.5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-foreground/45 mt-1 font-medium leading-relaxed">Publish interactive game guides, mission steps, or map insights.</p>
                  </div>
                </div>
              ...
              >
                <div className="flex space-x-3.5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-foreground/45 mt-1 font-medium leading-relaxed">Populate the Wiki with biographical info, voice actors, and stats.</p>
                  </div>
                </div>
              ...
              >
                <div className="flex space-x-3.5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-foreground/45 mt-1 font-medium leading-relaxed">Add codes, platforms, CSV batch uploads, or modify visibility.</p>
                  </div>
                </div>
        ...
        <div className="xl:col-span-4 space-y-6">
          {/* Content Pulse Panel */}
          <div className="bg-[#15131a] border border-card-border p-6 rounded-xl shadow-xl space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-black text-white tracking-widest uppercase font-mono">
                Content Pulse
              </h2>
            ...
            {isPulseEmpty ? (
              <div className="text-center py-8 border border-dashed border-card-border rounded-lg bg-[#0d0c10]/40">
