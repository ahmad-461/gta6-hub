  ...
  return (
    <div className="flex-grow flex flex-col relative bg-ink overflow-hidden text-paper">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[20%] left-[-15%] w-[600px] h-[600px] rounded-full bg-magenta/5 blur-[140px] z-0" />
        {/* Glow Blob 2 (orange right) */}
        <div className="absolute bottom-[20%] right-[-15%] w-[600px] h-[600px] rounded-full bg-orange/5 blur-[140px] z-0" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10 space-y-20">
        ...
        <section className="space-y-6 max-w-4xl text-left pt-8">
          <div className="flex items-center space-x-3 font-mono text-xs text-magenta tracking-widest uppercase font-bold">
            <span>SITE MISSION</span>
            <span className="h-[1px] w-12 bg-magenta" />
          </div>

          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-anton uppercase tracking-tight leading-[0.95] text-paper">
          ...
          <p className="text-base sm:text-lg text-paper-dim leading-relaxed font-normal max-w-3xl">
          ...
          <p className="text-sm text-paper-dim/80 leading-relaxed font-normal max-w-3xl">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 pt-4 items-stretch">
          {/* Creator Profile */}
          <div className="bg-ink-2 border border-[rgba(245,240,250,0.14)] rounded p-8 flex flex-col justify-between shadow-xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-orange/10 to-transparent blur-xl pointer-events-none" />

            <div className="space-y-6">
              <div className="space-y-2">
                <span className="text-[10px] font-bold font-mono text-orange uppercase tracking-widest">
                  CORE DEVELOPER
                </span>
            ...
            <div className="pt-6 mt-8 border-t border-[rgba(245,240,250,0.08)] flex flex-wrap gap-6 font-mono text-xs">
              <a
                ...
                className="relative flex items-center space-x-2 text-paper-dim hover:text-white transition-colors py-1 group"
              >
          ...
          <div className="bg-ink-2 border border-[rgba(245,240,250,0.14)] rounded p-8 flex flex-col justify-between shadow-xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-magenta/10 to-transparent blur-xl pointer-events-none" />

            <div className="space-y-6">
              <div className="space-y-2">
                <span className="text-[10px] font-bold font-mono text-magenta uppercase tracking-widest flex items-center gap-1.5">
                  <Shield className="w-3.5 h-3.5 text-magenta" /> CREDIBILITY DISCLOSURE
                </span>
                <h3 className="text-2xl font-anton uppercase text-paper">
            ...
            <p className="text-[10px] text-paper-dim/50 font-mono leading-relaxed mt-8 pt-4 border-t border-[rgba(245,240,250,0.08)]">
        ...
        <section className="relative border border-orange/30 bg-ink-2/40 backdrop-blur-md rounded p-12 text-center max-w-4xl mx-auto overflow-hidden">
          {/* Accent Reticles */}
          ...
          <div className="space-y-6 max-w-xl mx-auto">
            ...
            <div className="pt-2">
              <Link
                href="/news"
                className="inline-flex items-center gap-2 px-8 py-3.5 bg-magenta hover:bg-magenta/90 text-white font-bold uppercase tracking-wider text-xs rounded transition-all duration-300 font-mono shadow-[0_4px_20px_rgba(255,46,136,0.3)] hover:shadow-[0_4px_30px_rgba(255,46,136,0.5)] active:scale-95 duration-100"
              >
