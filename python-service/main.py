...
async def get_content_stats():
    ...
    if supabase_client:
        try:
            ...
            # Fallback to mock data if table read fails

    # Handle mock fallbacks if database is empty or connection fails
    if not articles and not guides:
        print("Using high-quality mock data for content stats.")
        articles = [
...
async def get_seo_audit():
    ...
    if not articles and not guides:
        print("Using high-quality mock data for SEO audit.")
        articles = [
...
async def get_topic_coverage():
    ...
    # Fallback/Seed mock data
    if not articles and not guides:
        print("Using high-quality mock data for topic coverage.")
        articles = [
